...
RSpec.describe "show plots", type: :system do
  ...
  it "shows plot's data" do
    ...
    expect(find_by_id("owner_type")).to have_content(plot.owner_type)
    ...
    expect(find_by_id("plot_number_cadastral")).to have_content(plot.cadastral_number)
    ...
    expect(find_by_id("plot_sale_status")).to have_content(plot.sale_status)
    expect(find_by_id("plot_description")).to have_content(plot.description)
  end
end
