...
module Erubis::Basic::Converter
  ...
  class << self
    # return regexp of pattern to parse eRuby script
    #
    # source://erubis//lib/erubis/converter.rb#118
    def pattern_regexp(pattern); end
...
module Erubis::XmlHelper
  ...
  # source://erubis//lib/erubis/helper.rb#33
  def h(value); end

  # source://erubis//lib/erubis/helper.rb#34
  def html_escape(value); end

  # source://erubis//lib/erubis/helper.rb#42
  def u(str); end
