...
class Array
  ...
  #     #=> "CSV,data\n"
  #
  # pkg:gem/csv#csv/core_ext/array.rb:6
...
class CSV
  ...
  #   end
  #
  # pkg:gem/csv#csv.rb:2376
  def add_row(row); end

  # pkg:gem/csv#csv.rb:2254
  def binmode(*args, **_arg1, &block); end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv.rb:2261
  def binmode?; end
  ...
  #
  # pkg:gem/csv#csv.rb:2192
  def encoding; end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv.rb:2309
  def eof; end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv.rb:2297
  def eof?; end
  ...
  # Since 3.2.3.
  #
  # pkg:gem/csv#csv.rb:2053
  def max_field_size; end

  # pkg:gem/csv#csv.rb:2279
  def path; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/csv#csv.rb:2124
  def return_headers?; end

  # Rewinds the underlying IO object and resets CSV's lineno() counter.
  #
  # pkg:gem/csv#csv.rb:2312
  def rewind; end
  ...
  #
  # pkg:gem/csv#csv.rb:2063
  def skip_lines; end

  # @raise [NotImplementedError]
  #
  # pkg:gem/csv#csv.rb:2283
  def stat(*args); end
  ...
  # @raise [NotImplementedError]
  #
  # pkg:gem/csv#csv.rb:2288
  def to_i; end

  # pkg:gem/csv#csv.rb:2293
  def to_io; end
...
class CSV::FieldsConverter
  ...
  #
  # pkg:gem/csv#csv/fields_converter.rb:13
  def initialize(options = T.unsafe(nil)); end

  # pkg:gem/csv#csv/fields_converter.rb:23
  def add_converter(name = T.unsafe(nil), &converter); end

  # pkg:gem/csv#csv/fields_converter.rb:47
  def convert(fields, headers, lineno, quoted_fields); end

  # pkg:gem/csv#csv/fields_converter.rb:39
  def each(&block); end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/fields_converter.rb:43
  def empty?; end

  private

  # pkg:gem/csv#csv/fields_converter.rb:85
  def builtin_converters; end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/fields_converter.rb:80
  def need_convert?; end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/fields_converter.rb:76
...
class CSV::MalformedCSVError < ::RuntimeError
  ...
  #
  # pkg:gem/csv#csv.rb:843
  def initialize(message, line_number); end

  # Returns the value of attribute line_number.
  #
  # pkg:gem/csv#csv.rb:841
  def line_number; end

  # Returns the value of attribute line_number.
  #
  # pkg:gem/csv#csv.rb:842
  def lineno; end
end
...
class CSV::Parser
  ...
  #
  # pkg:gem/csv#csv/parser.rb:326
  def initialize(input, options); end

  # pkg:gem/csv#csv/parser.rb:334
  def column_separator; end

  # pkg:gem/csv#csv/parser.rb:346
  def field_size_limit; end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/parser.rb:366
  def header_row?; end

  # pkg:gem/csv#csv/parser.rb:362
  def headers; end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/parser.rb:378
  def liberal_parsing?; end

  # pkg:gem/csv#csv/parser.rb:386
  def line; end

  # pkg:gem/csv#csv/parser.rb:382
  def lineno; end

  # pkg:gem/csv#csv/parser.rb:350
  def max_field_size; end

  # pkg:gem/csv#csv/parser.rb:390
  def parse(&block); end

  # pkg:gem/csv#csv/parser.rb:342
  def quote_character; end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/parser.rb:370
  def return_headers?; end

  # pkg:gem/csv#csv/parser.rb:338
  def row_separator; end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/parser.rb:374
  def skip_blanks?; end

  # pkg:gem/csv#csv/parser.rb:354
  def skip_lines; end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/parser.rb:358
  def unconverted_fields?; end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/parser.rb:431
  def use_headers?; end
  ...
  #
  # pkg:gem/csv#csv/parser.rb:1280
  def add_unconverted_fields(row, fields); end

  # pkg:gem/csv#csv/parser.rb:794
  def adjust_headers(headers, quoted_fields); end

  # pkg:gem/csv#csv/parser.rb:862
  def build_scanner; end

  # pkg:gem/csv#csv/parser.rb:716
  def detect_row_separator(sample, cr, lf); end

  # @yield [row]
  #
  # pkg:gem/csv#csv/parser.rb:1251
  def emit_row(row, quoted_fields, &block); end

  # pkg:gem/csv#csv/parser.rb:1236
  def ignore_broken_line; end

  # pkg:gem/csv#csv/parser.rb:746
  def last_line; end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/parser.rb:804
  def may_quoted?; end

  # pkg:gem/csv#csv/parser.rb:1191
  def parse_column_end; end

  # pkg:gem/csv#csv/parser.rb:1091
  def parse_column_value; end

  # pkg:gem/csv#csv/parser.rb:780
  def parse_headers(row); end

  # pkg:gem/csv#csv/parser.rb:929
  def parse_no_quote(&block); end

  # pkg:gem/csv#csv/parser.rb:960
  def parse_quotable_loose(&block); end

  # pkg:gem/csv#csv/parser.rb:1021
  def parse_quotable_robust(&block); end

  # pkg:gem/csv#csv/parser.rb:1149
  def parse_quoted_column_value; end

  # pkg:gem/csv#csv/parser.rb:1205
  def parse_row_end; end

  # pkg:gem/csv#csv/parser.rb:1121
  def parse_unquoted_column_value; end

  # A set of tasks to prepare the file in order to parse it
  #
  # pkg:gem/csv#csv/parser.rb:437
  def prepare; end

  # pkg:gem/csv#csv/parser.rb:494
  def prepare_backslash; end

  # pkg:gem/csv#csv/parser.rb:754
  def prepare_header; end

  # pkg:gem/csv#csv/parser.rb:740
  def prepare_line; end

  # pkg:gem/csv#csv/parser.rb:800
  def prepare_parser; end

  # pkg:gem/csv#csv/parser.rb:478
  def prepare_quote_character; end

  # pkg:gem/csv#csv/parser.rb:636
  def prepare_quoted; end

  # pkg:gem/csv#csv/parser.rb:568
  def prepare_separators; end

  # pkg:gem/csv#csv/parser.rb:509
  def prepare_skip_lines; end

  # pkg:gem/csv#csv/parser.rb:526
  def prepare_strip; end

  # pkg:gem/csv#csv/parser.rb:663
  def prepare_unquoted; end

  # pkg:gem/csv#csv/parser.rb:452
  def prepare_variable; end

  # pkg:gem/csv#csv/parser.rb:676
  def resolve_row_separator(separator); end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/parser.rb:909
  def skip_line?(line); end

  # pkg:gem/csv#csv/parser.rb:892
  def skip_needless_lines; end

  # pkg:gem/csv#csv/parser.rb:1242
  def start_row; end

  # pkg:gem/csv#csv/parser.rb:1218
  def strip_value(value); end

  # @raise [MalformedCSVError]
  #
  # pkg:gem/csv#csv/parser.rb:921
...
class CSV::Parser::InputsScanner
  ...
  #
  # pkg:gem/csv#csv/parser.rb:87
  def initialize(inputs, encoding, row_separator, chunk_size: T.unsafe(nil)); end

  # pkg:gem/csv#csv/parser.rb:248
  def check(pattern); end

  # @yield [buffer]
  #
  # pkg:gem/csv#csv/parser.rb:97
  def each_line(row_separator); end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/parser.rb:170
  def eos?; end

  # pkg:gem/csv#csv/parser.rb:197
  def keep_back; end

  # pkg:gem/csv#csv/parser.rb:227
  def keep_drop; end

  # pkg:gem/csv#csv/parser.rb:181
  def keep_end; end

  # pkg:gem/csv#csv/parser.rb:174
  def keep_start; end

  # pkg:gem/csv#csv/parser.rb:244
  def rest; end

  # pkg:gem/csv#csv/parser.rb:143
  def scan(pattern); end

  # pkg:gem/csv#csv/parser.rb:154
  def scan_all(pattern); end

  private

  # pkg:gem/csv#csv/parser.rb:257
  def adjust_last_keep; end

  # pkg:gem/csv#csv/parser.rb:285
  def read_chunk; end

  # pkg:gem/csv#csv/parser.rb:253
  def trace(*args); end
end
...
# pkg:gem/csv#csv/parser.rb:836
CSV::Parser::SCANNER_TEST = T.let(T.unsafe(nil), FalseClass)

# pkg:gem/csv#csv/parser.rb:565
...
class CSV::Parser::Scanner < ::StringScanner
  ...
  #
  # pkg:gem/csv#csv/parser.rb:42
  def initialize(*args); end

  # pkg:gem/csv#csv/parser.rb:47
  def each_line(row_separator); end

  # pkg:gem/csv#csv/parser.rb:65
  def keep_back; end

  # pkg:gem/csv#csv/parser.rb:69
  def keep_drop; end

  # pkg:gem/csv#csv/parser.rb:60
  def keep_end; end

  # pkg:gem/csv#csv/parser.rb:56
  def keep_start; end

  # pkg:gem/csv#csv/parser.rb:40
...
class CSV::Parser::UnoptimizedStringIO
  ...
  #
  # pkg:gem/csv#csv/parser.rb:819
  def initialize(string); end

  # pkg:gem/csv#csv/parser.rb:827
  def each_line(*args, &block); end

  # @return [Boolean]
  #
  # pkg:gem/csv#csv/parser.rb:831
  def eof?; end

  # pkg:gem/csv#csv/parser.rb:823
  def gets(*args); end
end
...
class CSV::Row
  ...
  #   row.each # => #<Enumerator: #<CSV::Row "Name":"Foo" "Name":"Bar" "Name":"Baz">:each>
  #
  # pkg:gem/csv#csv/row.rb:618
  def each_pair(&block); end

  # pkg:gem/csv#csv/row.rb:124
  ...
  #
  # pkg:gem/csv#csv/row.rb:410
  def push(*args); end

  # pkg:gem/csv#csv/row.rb:124
  def size(*args, **_arg1, &block); end

  # pkg:gem/csv#csv/row.rb:675
...
class CSV::Table
  ...
  #
  # pkg:gem/csv#csv/table.rb:887
  def delete_if(&block); end

  # Extracts the nested value specified by the sequence of +index+ or +header+ objects by calling dig at each step,
  # returning nil if any intermediate step is nil.
  #
  # pkg:gem/csv#csv/table.rb:1021
  ...
  #
  # pkg:gem/csv#csv/table.rb:930
  def each(&block); end

  # pkg:gem/csv#csv/table.rb:223
  def empty?(*args, **_arg1, &block); end
...
class CSV::Writer
  ...
  #
  # pkg:gem/csv#csv/writer.rb:16
  def initialize(output, options); end

  # Adds a new row
  #
  # pkg:gem/csv#csv/writer.rb:31
  def <<(row); end

  # Returns the value of attribute headers.
  #
  # pkg:gem/csv#csv/writer.rb:14
  def headers; end
  ...
  #
  # pkg:gem/csv#csv/writer.rb:13
  def lineno; end

  # Winds back to the beginning
  #
  # pkg:gem/csv#csv/writer.rb:64
  def rewind; end

  private

  # pkg:gem/csv#csv/writer.rb:70
  def prepare; end

  # pkg:gem/csv#csv/writer.rb:106
  def prepare_force_quotes_fields(force_quotes); end

  # pkg:gem/csv#csv/writer.rb:133
  def prepare_format; end

  # pkg:gem/csv#csv/writer.rb:78
  def prepare_header; end

  # pkg:gem/csv#csv/writer.rb:163
  def prepare_output; end

  # pkg:gem/csv#csv/writer.rb:190
  def quote(field, i); end

  # pkg:gem/csv#csv/writer.rb:181
...
class String
  ...
  #     #=> ["CSV", "data"]
  #
  # pkg:gem/csv#csv/core_ext/string.rb:6
