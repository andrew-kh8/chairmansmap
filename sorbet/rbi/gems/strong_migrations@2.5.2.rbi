...
module StrongMigrations
  class << self
    ...
    # Sets the attribute transaction_timeout
    #
    # @param value the value to set the attribute transaction_timeout to.
    #
    # source://strong_migrations//lib/strong_migrations.rb#28
...
class StrongMigrations::Adapters::AbstractAdapter
  ...
  # source://strong_migrations//lib/strong_migrations/adapters/abstract_adapter.rb#47
  ...
  # source://strong_migrations//lib/strong_migrations/adapters/abstract_adapter.rb#60
...
class StrongMigrations::Adapters::PostgreSQLAdapter < ::StrongMigrations::Adapters::AbstractAdapter
  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#49
  def add_column_default_safe?; end

  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#45
  def analyze_table(table); end

  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#162
  def auto_incrementing_types; end

  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#53
  def change_type_safe?(table, column, type, options, existing_column, existing_type); end

  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#35
  def check_lock_timeout(limit); end

  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#170
  ...
  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#156
  ...
  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#149
  ...
  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#31
  def set_lock_timeout(timeout); end
  ...
  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#135
  def writes_blocked?; end

  private

  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#211
  ...
  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#207
  def indexed?(table, column); end

  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#177
  def set_timeout(setting, timeout); end

  # do not memoize
  # want latest value
  #
  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#222
  def time_zone; end

  # units: https://www.postgresql.org/docs/current/config-setting.html
  #
  # source://strong_migrations//lib/strong_migrations/adapters/postgresql_adapter.rb#185
...
class StrongMigrations::Checker
  ...
  # source://strong_migrations//lib/strong_migrations/checker.rb#221
  def adapter; end

  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/checker.rb#268
  ...
  # source://strong_migrations//lib/strong_migrations/checker.rb#176
  def check_version_supported; end

  # source://strong_migrations//lib/strong_migrations/checker.rb#241
  def connection; end

  # source://strong_migrations//lib/strong_migrations/checker.rb#245
  def db_config_name; end

  # REINDEX INDEX CONCURRENTLY leaves a new invalid index if it fails, so use remove_index instead
  #
  # source://strong_migrations//lib/strong_migrations/checker.rb#281
  ...
  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/checker.rb#213
  def safe?; end

  # source://strong_migrations//lib/strong_migrations/checker.rb#190
  def set_timeouts; end

  # source://strong_migrations//lib/strong_migrations/checker.rb#217
  def version; end

  # source://strong_migrations//lib/strong_migrations/checker.rb#258
...
module StrongMigrations::Checks
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#477
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#184
  def check_add_unique_constraint(*args); end

  # source://strong_migrations//lib/strong_migrations/checks.rb#199
  def check_change_column(*args); end

  # source://strong_migrations//lib/strong_migrations/checks.rb#246
  def check_change_column_default(*args); end

  # source://strong_migrations//lib/strong_migrations/checks.rb#258
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#326
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#396
  def check_rename_table; end

  # source://strong_migrations//lib/strong_migrations/checks.rb#400
  def check_validate_check_constraint; end

  # source://strong_migrations//lib/strong_migrations/checks.rb#406
  def check_validate_foreign_key; end

  # source://strong_migrations//lib/strong_migrations/checks.rb#454
  ...
  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/checks.rb#422
  def mariadb?; end

  # source://strong_migrations//lib/strong_migrations/checks.rb#502
  def migration_suffix; end

  # source://strong_migrations//lib/strong_migrations/checks.rb#506
  def model_name(table); end

  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/checks.rb#418
  def mysql?; end

  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/checks.rb#498
  def new_column?(table, column); end

  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/checks.rb#494
  ...
  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/checks.rb#414
  def postgresql?; end

  # only quote when needed
  # important! only use for display purposes
  #
  # source://strong_migrations//lib/strong_migrations/checks.rb#490
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#450
...
module StrongMigrations::Migration
  ...
  # source://strong_migrations//lib/strong_migrations/migration.rb#21
  ...
  # source://strong_migrations//lib/strong_migrations/migration.rb#41
...
module StrongMigrations::SafeMethods
  ...
  #
  # source://strong_migrations//lib/strong_migrations/safe_methods.rb#137
  def disable_transaction; end

  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/safe_methods.rb#144
  def in_transaction?; end

  # source://strong_migrations//lib/strong_migrations/safe_methods.rb#61
  ...
  # source://strong_migrations//lib/strong_migrations/safe_methods.rb#77
...
class StrongMigrations::WrappedConnection
  ...
  # source://strong_migrations//lib/strong_migrations/schema_dumper.rb#11
