...
module RGeo::Geos::Analysis
  class << self
    # source://rgeo//lib/rgeo/geos.rb#27
    def ccw?(_arg0); end
...
class RGeo::Geos::CAPIFactory
  ...
  # @return [Boolean]
  #
  # source://rgeo//lib/rgeo/geos/capi_factory.rb#104
  def ==(other); end
  ...
  class << self
    ...
    # See RGeo::Geos.factory for a list of supported options.
    #
    # source://rgeo//lib/rgeo/geos/capi_factory.rb#88
...
class RGeo::Geos::CAPIGeometryCollectionImpl
  ...
  # source://rgeo//lib/rgeo/geos/capi_feature_classes.rb#156
  def *(*args); end
...
module RGeo::Geos::CAPIGeometryMethods
  ...
  # source://rgeo//lib/rgeo/geos/capi_feature_classes.rb#71
  def to_s; end
