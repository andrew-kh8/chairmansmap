...
#
# pkg:gem/shrine#lib/shrine/uploaded_file.rb:7
class Shrine
  include ::Shrine::InstanceMethods
  extend ::Shrine::ClassMethods

  class << self
    # pkg:gem/shrine#lib/shrine/version.rb:4
    def version; end
  end
end
...
#
# pkg:gem/shrine#lib/shrine/attacher.rb:6
class Shrine::Attacher
  include ::Shrine::Attacher::InstanceMethods
  extend ::Shrine::Attacher::ClassMethods
end

# pkg:gem/shrine#lib/shrine/attacher.rb:9
module Shrine::Attacher::ClassMethods
  ...
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:25
  def from_data(data, **_arg1); end
  ...
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:17
  def inspect; end

  # Returns the Shrine class that this attacher class is namespaced
  # under.
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:12
...
module Shrine::Attacher::InstanceMethods
  ...
  #     attacher.assign("")
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:70
  def assign(value, **_arg1); end
  ...
  #     attacher.attach(nil)
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:116
  def attach(io, storage: T.unsafe(nil), **_arg2); end
  ...
  #     attacher.attach_cached({ "id" => "...", "storage" => "cache", "metadata" => {} })
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:95
  def attach_cached(value, **_arg1); end
  ...
  # @return [Boolean]
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:272
  def attached?; end

  # Returns the uploader that is used for the temporary storage.
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:55
  def cache; end

  # Returns the temporary storage identifier.
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:50
  def cache_key; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:280
  ...
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:219
  def change(file); end
  ...
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:295
  def data; end
  ...
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:210
  def destroy; end
  ...
  #     attacher.file.exists? #=> false
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:201
  ...
  #     attacher.file #=> #<Shrine::UploadedFile>
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:312
  def file=(file); end
  ...
  #     attacher.changed? #=> false
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:143
  def finalize; end
  ...
  #     attacher.get #=> nil
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:240
  def get; end
  ...
  #     attacher.file #=> #<Shrine::UploadedFile>
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:304
  ...
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:170
  def promote(storage: T.unsafe(nil), **_arg1); end
  ...
  #     attacher.stored? #=> true
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:161
  def promote_cached(**_arg0); end

  # Plugins can override this if they want something to be done in a
  # "before save" callback.
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:151
  def save; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:288
  ...
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:181
  def upload(io, storage = T.unsafe(nil), **_arg2); end
  ...
  #     #=> #<Shrine::UploadedFile ...>
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:332
  ...
  #     attacher.url #=> nil
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:252
  def url(**_arg0); end
  ...
  #     #=> #<Shrine::UploadedFile>
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:361
  ...
  # @return [Boolean]
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:389
  def change?(file); end
  ...
  # @return [Boolean]
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:379
  def destroy?; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:374
  def promote?; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/shrine#lib/shrine/attacher.rb:394
...
module Shrine::Attachment::ClassMethods
  ...
  # reflect the likely name for the class.
  #
  # pkg:gem/shrine#lib/shrine/attachment.rb:18
  def inspect; end

  # Returns the Shrine class that this attachment class is
  # namespaced under.
  #
  # pkg:gem/shrine#lib/shrine/attachment.rb:13
  def shrine_class; end
...
# pkg:gem/shrine#lib/shrine/attachment.rb:30
module Shrine::Attachment::InstanceMethods
  ...
  #
  # pkg:gem/shrine#lib/shrine/attachment.rb:34
  def initialize(name, **options); end

  # Returns name of the attachment this module provides.
  #
  # pkg:gem/shrine#lib/shrine/attachment.rb:40
  ...
  #
  # pkg:gem/shrine#lib/shrine/attachment.rb:52
  def inspect; end

  # Returns options that are to be passed to the Attacher.
  #
  # pkg:gem/shrine#lib/shrine/attachment.rb:45
  def options; end

  # Returns the Shrine class that this attachment's class is namespaced
  # under.
  #
  # pkg:gem/shrine#lib/shrine/attachment.rb:59
  def shrine_class; end
  ...
  #     Shrine::Attachment.new(:image).to_s #=> "#<Shrine::Attachment(image)>"
  #
  # pkg:gem/shrine#lib/shrine/attachment.rb:55
  def to_s; end
end

# pkg:gem/shrine#lib/shrine.rb:40
module Shrine::ClassMethods
  ...
  #     end
  #
  # pkg:gem/shrine#lib/shrine.rb:102
  def Attachment(name, **_arg1); end
  ...
  #     end
  #
  # pkg:gem/shrine#lib/shrine.rb:106
  def [](name, **_arg1); end
  ...
  #     end
  #
  # pkg:gem/shrine#lib/shrine.rb:105
  def attachment(name, **_arg1); end

  # Prints a deprecation warning to the logger.
  #
  # pkg:gem/shrine#lib/shrine.rb:161
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:92
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:52
  def inherited(subclass); end

  # A logger instance.
  #
  # pkg:gem/shrine#lib/shrine.rb:48
  def logger; end
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:42
  def opts; end
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:75
  def plugin(plugin, *_arg1, **_arg2, &_arg3); end

  # A hash of storages with their symbol identifiers.
  #
  # pkg:gem/shrine#lib/shrine.rb:45
  def storages; end
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:111
  def upload(io, storage, **_arg2); end
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:120
  def uploaded_file(object); end

  # Prints a warning to the logger.
  #
  # pkg:gem/shrine#lib/shrine.rb:156
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:140
...
module Shrine::InstanceMethods
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:232
  def extract_metadata(io, **_arg1); end
  ...
  # location.
  #
  # pkg:gem/shrine#lib/shrine.rb:226
  def generate_location(io, metadata: T.unsafe(nil), **_arg2); end

  # The class-level options hash. This should probably not be modified at
  # the instance level.
  #
  # pkg:gem/shrine#lib/shrine.rb:242
  def opts; end

  # Returns the storage object referenced by the identifier.
  #
  # pkg:gem/shrine#lib/shrine.rb:195
  def storage; end

  # The symbol identifier for the storage used by the uploader.
  #
  # pkg:gem/shrine#lib/shrine.rb:183
  def storage_key; end
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:208
  def upload(io, **_arg1); end
  ...
  # @raise [InvalidFile]
  #
  # pkg:gem/shrine#lib/shrine.rb:312
  def _enforce_io(io); end

  # pkg:gem/shrine#lib/shrine.rb:248
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:303
  def get_location(io, location: T.unsafe(nil), **_arg2); end

  # If the IO object is a Shrine::UploadedFile, it simply copies over its
  # metadata, otherwise it calls #extract_metadata.
  #
  # pkg:gem/shrine#lib/shrine.rb:288
  def get_metadata(io, metadata: T.unsafe(nil), **_arg2); end
end

# Raised when a file is not a valid IO.
#
# pkg:gem/shrine#lib/shrine.rb:21
class Shrine::InvalidFile < ::Shrine::Error
  # @return [InvalidFile] a new instance of InvalidFile
  #
  # pkg:gem/shrine#lib/shrine.rb:22
  def initialize(io, missing_methods); end
end

# Raised by Shrine.find_storage when the storage isn't registered.
#
# pkg:gem/shrine#lib/shrine.rb:32
class Shrine::MissingStorage < ::Shrine::Error; end

# Module in which all Shrine plugins should be stored. Also contains logic
# for registering and loading plugins.
#
# pkg:gem/shrine#lib/shrine/plugins.rb:6
module Shrine::Plugins
  class << self
    # Delegate to the plugin's `load_dependencies` method.
    #
    # pkg:gem/shrine#lib/shrine/plugins.rb:29
    def configure(plugin, uploader, *_arg2, **_arg3, &_arg4); end

    # Delegate to the plugin's `load_dependencies` method.
    #
    # pkg:gem/shrine#lib/shrine/plugins.rb:22
    def load_dependencies(plugin, uploader, *_arg2, **_arg3, &_arg4); end
    ...
    # correctly.
    #
    # pkg:gem/shrine#lib/shrine/plugins.rb:13
    ...
    #
    # pkg:gem/shrine#lib/shrine/plugins.rb:39
...
module Shrine::UploadedFile::InstanceMethods
  ...
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:123
  ...
  # @return [Boolean]
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:161
  def eof?; end

  # Returns true if the other UploadedFile is uploaded to the same
  # storage and it has the same #id.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:233
  def eql?(other); end
  ...
  # @return [Boolean]
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:190
  def exists?; end

  # The extension derived from #id if present, otherwise it's derived
  # from #original_filename.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:54
  def extension; end

  # Enables using UploadedFile objects as hash keys.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:236
  def hash; end

  # The location where the file was uploaded to the storage.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:28
  def id; end

  # Returns simplified inspect output.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:256
  def inspect; end

  # A hash of file metadata that was extracted during upload.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:34
  def metadata; end

  # The MIME type of the uploaded file.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:67
  def mime_type; end
  ...
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:94
  def open(**_arg0); end
  ...
  # @return [Boolean]
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:179
  def opened?; end

  # The filename that was extracted from the uploaded file.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:48
  def original_filename; end

  # Part of complying to the IO interface. It delegates to the internally
  # opened IO object.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:155
  def read(*_arg0); end

  # Uploads a new file to this file's location and returns it.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:195
  def replace(io, **_arg1); end

  # Part of complying to the IO interface. It delegates to the internally
  # opened IO object.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:167
  def rewind; end

  # Returns the Shrine class that this file's class is namespaced under.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:251
  def shrine_class; end

  # The filesize of the uploaded file.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:62
  def size; end

  # Returns the storage that this file was uploaded to.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:246
  def storage; end

  # The identifier of the storage the file is uploaded to.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:31
  def storage_key; end
  ...
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:144
  def stream(destination, **_arg1); end

  # Returns an opened IO object for the uploaded file.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:206
  def to_io; end

  # Returns the data hash in the JSON format. Suitable for storing in a
  # database column or passing to a background job.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:212
  def to_json(*_arg0); end

  # Returns an uploader object for the corresponding storage.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:241
  def uploader; end

  # Calls `#url` on the storage, forwarding any given URL options.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:184
  def url(**_arg0); end

  private

  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:268
  def _open(**_arg0); end

  # Returns an opened IO object for the uploaded file by calling `#open`
  # on the storage.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:264
  def io; end
end

# pkg:gem/shrine#lib/shrine/uploaded_file.rb:25
Shrine::UploadedFile::InstanceMethods::RFC2396_PARSER = T.let(T.unsafe(nil), URI::RFC2396_Parser)

# pkg:gem/shrine#lib/shrine/version.rb:8
module Shrine::VERSION; end

# pkg:gem/shrine#lib/shrine/version.rb:9
Shrine::VERSION::MAJOR = T.let(T.unsafe(nil), Integer)

# pkg:gem/shrine#lib/shrine/version.rb:10
Shrine::VERSION::MINOR = T.let(T.unsafe(nil), Integer)

# pkg:gem/shrine#lib/shrine/version.rb:12
Shrine::VERSION::PRE = T.let(T.unsafe(nil), T.untyped)

# pkg:gem/shrine#lib/shrine/version.rb:14
Shrine::VERSION::STRING = T.let(T.unsafe(nil), String)

# pkg:gem/shrine#lib/shrine/version.rb:11
