...
class Fasterer::Analyzer
  ...
  # Returns the value of attribute file_path.
  #
  # source://fasterer//lib/fasterer/analyzer.rb#13
  def path; end
...
class Fasterer::MethodCall
  ...
  # Returns the value of attribute method_name.
  #
  # source://fasterer//lib/fasterer/method_call.rb#10
  def name; end
...
class Fasterer::MethodDefinition
  ...
  # Returns the value of attribute method_name.
  #
  # source://fasterer//lib/fasterer/method_definition.rb#9
  def name; end
...
class Fasterer::Offense
  ...
  #
  # source://fasterer//lib/fasterer/offense.rb#6
  def line; end
  ...
  #
  # source://fasterer//lib/fasterer/offense.rb#5
  def name; end
...
class Fasterer::OffenseCollector
  ...
  # source://fasterer//lib/fasterer/offense_collector.rb#15
...
module Fasterer::Offensive
  ...
  # @return [Boolean]
  #
  # source://fasterer//lib/fasterer/scanners/offensive.rb#11
