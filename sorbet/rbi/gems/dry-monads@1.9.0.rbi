...
module Dry::Monads
  ...
  class << self
    ...
    # @return [Module]
    #
    # source://dry-monads//lib/dry/monads/result.rb#363
    ...
    # @return [Module]
    #
    # source://dry-monads//lib/dry/monads.rb#71
    def [](*monads); end
    ...
    # @private
    #
    # source://dry-monads//lib/dry/monads.rb#34
    def included(base); end

    # @api private
    #
    # source://dry-monads//lib/dry/monads.rb#17
    def loader; end
    ...
    # @return [Boolean]
    #
    # source://dry-monads//lib/dry/monads/registry.rb#66
    def all_loaded?; end

    # @api private
    # @private
    #
    # source://dry-monads//lib/dry/monads/registry.rb#59
    ...
    # @private
    #
    # source://dry-monads//lib/dry/monads/registry.rb#49
...
# source://dry-monads//lib/dry/monads/extensions/pretty_print.rb#5
module Dry::Monads::Extensions; end

# source://dry-monads//lib/dry/monads/extensions/pretty_print.rb#6
module Dry::Monads::Extensions::PrettyPrint; end

# source://dry-monads//lib/dry/monads/extensions/pretty_print.rb#27
class Dry::Monads::Extensions::PrettyPrint::LazyPrintValue < ::Module
  # @return [LazyPrintValue] a new instance of LazyPrintValue
  #
  # source://dry-monads//lib/dry/monads/extensions/pretty_print.rb#28
  def initialize(constructor, success_prefix: T.unsafe(nil), error_prefix: T.unsafe(nil)); end
end

# source://dry-monads//lib/dry/monads/extensions/pretty_print.rb#7
class Dry::Monads::Extensions::PrettyPrint::PrintValue < ::Module
  # @return [PrintValue] a new instance of PrintValue
  #
  # source://dry-monads//lib/dry/monads/extensions/pretty_print.rb#8
...
# @see Result::Failure
#
# source://dry-monads//lib/dry/monads/result.rb#328
Dry::Monads::Failure = Dry::Monads::Result::Failure

# @api private
# @see Validated::Invalid
#
# source://dry-monads//lib/dry/monads/validated.rb#273
...
class Dry::Monads::Lazy < ::Dry::Monads::Task
  # source://dry-monads//lib/dry/monads/lazy.rb#44
  def complete?(*args, &block); end

  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/lazy.rb#43
  def evaluated?; end
  ...
  # @return [Lazy]
  #
  # source://dry-monads//lib/dry/monads/lazy.rb#37
  def force; end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/lazy.rb#31
  def force!; end

  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/lazy.rb#62
  def inspect; end

  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/lazy.rb#49
  def to_s; end
  ...
  class << self
    ...
    # source://dry-monads//lib/dry/monads/lazy.rb#24
...
# Lazy constructors
#
# source://dry-monads//lib/dry/monads/lazy.rb#66
...
module Dry::Monads::Lazy::Mixin::Constructors
  ...
  # @return [Lazy]
  #
  # source://dry-monads//lib/dry/monads/lazy.rb#79
  def Lazy(&_arg0); end
end

# @see Dry::Monads::Lazy
#
# source://dry-monads//lib/dry/monads/lazy.rb#68
...
class Dry::Monads::List
  ...
  #
  # source://dry-monads//lib/dry/monads/list.rb#83
  ...
  # @return [List]
  #
  # source://dry-monads//lib/dry/monads/list.rb#145
  def +(other); end
  ...
  # @return [List]
  #
  # source://dry-monads//lib/dry/monads/list.rb#282
  ...
  # @return [List]
  #
  # source://dry-monads//lib/dry/monads/list.rb#99
  def bind(*args); end
  ...
  # @return [List]
  #
  # source://dry-monads//lib/dry/monads/list.rb#315
  def collect; end
  ...
  #   end
  #
  # source://dry-monads//lib/dry/monads/list.rb#340
  def deconstruct; end
  ...
  #
  # source://dry-monads//lib/dry/monads/list.rb#193
  def empty?; end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/list.rb#166
  def first; end
  ...
  # @return [List]
  #
  # source://dry-monads//lib/dry/monads/list.rb#117
  def fmap(*args); end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/list.rb#178
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/list.rb#188
  ...
  # @return [Maybe<Object>]
  #
  # source://dry-monads//lib/dry/monads/list.rb#219
  def head; end
  ...
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/list.rb#153
  def inspect; end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/list.rb#171
  def last; end
  ...
  #
  # source://dry-monads//lib/dry/monads/list.rb#130
  def map(&block); end
  ...
  # @return [Monad]
  #
  # source://dry-monads//lib/dry/monads/list.rb#290
  def monad; end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/list.rb#179
  ...
  # @return [List]
  #
  # source://dry-monads//lib/dry/monads/list.rb#214
  def reverse; end
  ...
  # @return [List]
  #
  # source://dry-monads//lib/dry/monads/list.rb#204
  ...
  # @return [Integer]
  #
  # source://dry-monads//lib/dry/monads/list.rb#209
  def size; end
  ...
  # @return [List]
  #
  # source://dry-monads//lib/dry/monads/list.rb#198
  def sort; end
  ...
  # @return [List]
  #
  # source://dry-monads//lib/dry/monads/list.rb#224
  def tail; end

  # Internal array value
  # Coerces to an array
  #
  # source://dry-monads//lib/dry/monads/list.rb#161
  def to_a; end

  # Internal array value
  # Coerces to an array
  #
  # source://dry-monads//lib/dry/monads/list.rb#160
  def to_ary; end
  ...
  # @return [List]
  #
  # source://dry-monads//lib/dry/monads/list.rb#295
  def to_monad; end
  ...
  #
  # source://dry-monads//lib/dry/monads/list.rb#263
  def traverse(proc = T.unsafe(nil), &block); end

  # Internal array value
  #
  # source://dry-monads//lib/dry/monads/list.rb#80
  def type; end
  ...
  #
  # source://dry-monads//lib/dry/monads/list.rb#231
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/list.rb#251
  def typed?; end
  ...
  # source://dry-monads//lib/dry/monads/list.rb#344
  ...
  class << self
    ...
    # @return [List]
    #
    # source://dry-monads//lib/dry/monads/list.rb#19
    ...
    # @return [List]
    #
    # source://dry-monads//lib/dry/monads/list.rb#39
    ...
    #
    # source://dry-monads//lib/dry/monads/list.rb#56
...
# Empty list
#
# source://dry-monads//lib/dry/monads/list.rb#347
Dry::Monads::List::EMPTY = T.let(T.unsafe(nil), Dry::Monads::List)

# @private
#
# source://dry-monads//lib/dry/monads/list.rb#350
class Dry::Monads::List::ListBuilder
  # @return [ListBuilder] a new instance of ListBuilder
  #
  # source://dry-monads//lib/dry/monads/list.rb#357
  def initialize(type); end

  # source://dry-monads//lib/dry/monads/list.rb#359
  def [](*args); end

  # source://dry-monads//lib/dry/monads/list.rb#361
  def coerce(value); end

  # source://dry-monads//lib/dry/monads/list.rb#363
  def pure(val = T.unsafe(nil), &block); end

  # Returns the value of attribute type.
  #
  # source://dry-monads//lib/dry/monads/list.rb#355
  def type; end

  class << self
    # source://dry-monads//lib/dry/monads/list.rb#352
    def [](*_arg0); end
  end
end
...
# @api public
#
# source://dry-monads//lib/dry/monads/list.rb#387
module Dry::Monads::List::Mixin
  ...
  # @return [List]
  #
  # source://dry-monads//lib/dry/monads/list.rb#396
  def List(value); end
end
...
# @see Dry::Monads::List
#
# source://dry-monads//lib/dry/monads/list.rb#392
...
# List of results
#
# source://dry-monads//lib/dry/monads/list.rb#373
...
# List of tries
#
# source://dry-monads//lib/dry/monads/list.rb#379
Dry::Monads::List::Try = T.let(T.unsafe(nil), Dry::Monads::List::ListBuilder)

# List of validation results
#
# source://dry-monads//lib/dry/monads/list.rb#382
...
class Dry::Monads::Maybe
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#50
  def failure?; end
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#53
  def some?; end
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#54
  def success?; end
  ...
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#59
  def to_maybe; end
  ...
  # @return [Maybe::Some, Maybe::None]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#64
  def to_monad; end
  ...
  class << self
    ...
    # source://dry-monads//lib/dry/monads/maybe.rb#29
...
module Dry::Monads::Maybe::Hash
  class << self
    ...
    # @return [Maybe<::Hash>]
    #
    # source://dry-monads//lib/dry/monads/maybe.rb#316
    ...
    # @return [::Hash]
    #
    # source://dry-monads//lib/dry/monads/maybe.rb#339
    def filter(hash); end
  end
end
...
# @api public
#
# source://dry-monads//lib/dry/monads/maybe.rb#268
...
# @private
#
# source://dry-monads//lib/dry/monads/maybe.rb#277
module Dry::Monads::Maybe::Mixin::Constructors
  ...
  # @return [Maybe::None]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#298
  def None; end
  ...
  # @overload Some
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#292
...
#
# source://dry-monads//lib/dry/monads/maybe.rb#270
Dry::Monads::Maybe::Mixin::Maybe = Dry::Monads::Maybe

# @api public
# @see Maybe::None
#
# source://dry-monads//lib/dry/monads/maybe.rb#274
Dry::Monads::Maybe::Mixin::None = Dry::Monads::Maybe::None

# @api public
# @see Maybe::Some
#
# source://dry-monads//lib/dry/monads/maybe.rb#272
...
# @api public
#
# source://dry-monads//lib/dry/monads/maybe.rb#177
class Dry::Monads::Maybe::None < ::Dry::Monads::Maybe
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#244
  def ==(other); end
  ...
  #   end
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#259
  def deconstruct; end

  # @api private
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#242
  def eql?(other); end
  ...
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#264
  def filter(_ = T.unsafe(nil), &_arg1); end

  # @api public
  # @private
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#247
  def hash; end

  # @api public
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#239
  def inspect; end

  # @api public
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#205
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#217
  def or(*args); end
  ...
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#235
  ...
  # @return [Failure<Any>]
  #
  # source://dry-monads//lib/dry/monads/result.rb#383
  def to_result(fail = T.unsafe(nil)); end

  # @api public
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#238
  def to_s; end
  ...
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#196
  def trace; end

  class << self
    # source://dry-monads//lib/dry/monads/maybe.rb#181
    def instance; end
    ...
    # @api private
    #
    # source://dry-monads//lib/dry/monads/maybe.rb#184
...
# @api public
#
# source://dry-monads//lib/dry/monads/maybe.rb#75
class Dry::Monads::Maybe::Some < ::Dry::Monads::Maybe
  ...
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#91
  ...
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#153
  ...
  #   other values will be wrapped with Some
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#109
  def fmap(*_arg0, **_arg1, &_arg2); end

  # @api public
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#171
  def inspect; end
  ...
  #   other values will be wrapped with Some
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#142
  def maybe(*_arg0, **_arg1, &_arg2); end
  ...
  # @return [Success<Any>]
  #
  # source://dry-monads//lib/dry/monads/result.rb#374
  def to_result(_fail = T.unsafe(nil), &_arg1); end

  # @api public
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#164
  def to_s; end
  ...
  class << self
    ...
    # @api public
    #
    # source://dry-monads//lib/dry/monads/maybe.rb#89
    def [](*value); end

    # source://dry-monads//lib/dry/monads/maybe.rb#77
    def call(*_arg0); end
...
# @see Maybe::None
#
# source://dry-monads//lib/dry/monads/maybe.rb#352
...
class Dry::Monads::Result
  ...
  # @return [Monad]
  #
  # source://dry-monads//lib/dry/monads/result.rb#48
  def monad; end
  ...
  #
  # source://dry-monads//lib/dry/monads/result.rb#42
  def to_monad; end
...
# @api public
#
# source://dry-monads//lib/dry/monads/result.rb#135
class Dry::Monads::Result::Failure < ::Dry::Monads::Result
  ...
  #
  # source://dry-monads//lib/dry/monads/result.rb#170
  ...
  # @overload alt_map
  #
  # source://dry-monads//lib/dry/monads/result.rb#270
  ...
  #
  # source://dry-monads//lib/dry/monads/result.rb#258
  def either(_, g); end

  # @api public
  # @private
  #
  # source://dry-monads//lib/dry/monads/result.rb#177
  def failure; end
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/result.rb#185
  def failure?; end
  ...
  #
  # source://dry-monads//lib/dry/monads/result.rb#233
  def flip; end

  # @api public
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/result.rb#228
  def inspect; end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/result.rb#201
  def or(*args); end
  ...
  #
  # source://dry-monads//lib/dry/monads/result.rb#218
  def or_fmap(*_arg0, **_arg1, &_arg2); end
  ...
  # @api public
  #
  # source://dry-monads//lib/dry/monads/result.rb#182
  def result(f, _); end
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/result.rb#188
  def success?; end

  # @return [Maybe::None]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#367
  def to_maybe; end

  # @api public
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/result.rb#221
  def to_s; end
  ...
  #
  # source://dry-monads//lib/dry/monads/validated.rb#287
  def to_validated; end
  ...
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/result.rb#166
  def trace; end

  # @api public
  # @see RightBiased::Left#value_or
  #
  # source://dry-monads//lib/dry/monads/result.rb#236
  ...
  class << self
    ...
    # @api public
    #
    # source://dry-monads//lib/dry/monads/result.rb#151
    def [](*value); end

    # source://dry-monads//lib/dry/monads/result.rb#139
    def call(*_arg0); end
    ...
    # @return [Proc]
    #
    # source://dry-monads//lib/dry/monads/result.rb#158
    def to_proc; end
  end
end
...
class Dry::Monads::Result::Fixed < ::Module
  ...
  #
  # source://dry-monads//lib/dry/monads/result/fixed.rb#13
  ...
  # @api private
  #
  # source://dry-monads//lib/dry/monads/result/fixed.rb#35
  def included(base); end
...
# @api public
#
# source://dry-monads//lib/dry/monads/result.rb#279
...
# @api public
#
# source://dry-monads//lib/dry/monads/result.rb#287
module Dry::Monads::Result::Mixin::Constructors
  ...
  # @overload Success
  #
  # source://dry-monads//lib/dry/monads/result.rb#298
...
# @see Result::Failure
#
# source://dry-monads//lib/dry/monads/result.rb#283
Dry::Monads::Result::Mixin::Failure = Dry::Monads::Result::Failure

# @api public
# @see Result::Success
#
# source://dry-monads//lib/dry/monads/result.rb#281
...
# @api public
#
# source://dry-monads//lib/dry/monads/result.rb#53
class Dry::Monads::Result::Success < ::Dry::Monads::Result
  ...
  #
  # source://dry-monads//lib/dry/monads/result.rb#72
  ...
  # @return [Result::Success]
  #
  # source://dry-monads//lib/dry/monads/result.rb#129
  ...
  #
  # source://dry-monads//lib/dry/monads/result.rb#107
  def either(f, _); end
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/result.rb#83
  def failure?; end
  ...
  #
  # source://dry-monads//lib/dry/monads/result.rb#122
  def flip; end
  ...
  # @return [Result::Success]
  #
  # source://dry-monads//lib/dry/monads/result.rb#97
  def fmap(*_arg0, **_arg1, &_arg2); end

  # @api public
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/result.rb#117
  def inspect; end
  ...
  # @api public
  #
  # source://dry-monads//lib/dry/monads/result.rb#69
  def success; end
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/result.rb#86
  def success?; end

  # @return [Maybe]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#359
  def to_maybe; end

  # @api public
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/result.rb#110
  def to_s; end
  ...
  #
  # source://dry-monads//lib/dry/monads/validated.rb#280
  def to_validated; end
  ...
  class << self
    ...
    # @api public
    #
    # source://dry-monads//lib/dry/monads/result.rb#67
    def [](*value); end

    # source://dry-monads//lib/dry/monads/result.rb#54
    def call(*_arg0); end
...
# @api public
#
# source://dry-monads//lib/dry/monads/right_biased.rb#234
module Dry::Monads::RightBiased::Left
  ...
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#319
  def and(_, &_arg1); end
  ...
  # @return [RightBiased::Left]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#301
  ...
  # @return [RightBiased::Left]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#246
  ...
  #   end
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#332
  def deconstruct; end
  ...
  # @return [RightBiased::Left]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#307
  def discard; end
  ...
  # @return [RightBiased::Left]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#313
  def flatten; end
  ...
  # @return [RightBiased::Left]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#258
  def fmap(*_arg0, **_arg1, &_arg2); end
  ...
  # @raise [UnwrapError]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#240
  def value!; end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#289
  def value_or(val = T.unsafe(nil)); end
  ...
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#275
  def |(alt); end
  ...
  class << self
    ...
    #
    # source://dry-monads//lib/dry/monads/right_biased.rb#237
...
module Dry::Monads::RightBiased::Right
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#122
  def ===(other); end
  ...
  # @return [RightBiased::Left, RightBiased::Right]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#163
  def and(mb); end
  ...
  # @return [RightBiased::Left, RightBiased::Right]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#112
  ...
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#40
  ...
  #   end
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#185
  def deconstruct; end
  ...
  #   end
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#206
  def deconstruct_keys(keys); end
  ...
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#134
  def discard; end
  ...
  # @return [RightBiased::Right, RightBiased::Left]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#145
  def flatten; end
  ...
  # @return [RightBiased::Right]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#72
  def fmap(*_arg0, **_arg1, &_arg2); end
  ...
  # @return [RightBiased::Right]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#78
  def or(*_arg0, **_arg1, &_arg2); end
  ...
  # @return [RightBiased::Right]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#92
  def or_fmap(*_arg0, **_arg1, &_arg2); end
  ...
  # @return [RightBiased::Right]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#66
  def tee(*_arg0, **_arg1, &_arg2); end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#97
  ...
  # @return [RightBiased::Right]
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#86
  def |(_alt); end
  ...
  # @api private
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#226
  def curry; end

  # @api private
  #
  # source://dry-monads//lib/dry/monads/right_biased.rb#217
...
# @see Maybe::Some
#
# source://dry-monads//lib/dry/monads/maybe.rb#350
Dry::Monads::Some = Dry::Monads::Maybe::Some

# @api private
# @see Result::Success
#
# source://dry-monads//lib/dry/monads/result.rb#326
...
class Dry::Monads::Task
  ...
  #
  # source://dry-monads//lib/dry/monads/task.rb#87
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/task.rb#191
  def ==(other); end
  ...
  # @return [Task]
  #
  # source://dry-monads//lib/dry/monads/task.rb#222
  ...
  # @return [Task]
  #
  # source://dry-monads//lib/dry/monads/task.rb#119
  def bind(&block); end
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/task.rb#201
  def complete?; end
  ...
  # @return [Task]
  #
  # source://dry-monads//lib/dry/monads/task.rb#230
  def discard; end
  ...
  # @return [Task]
  #
  # source://dry-monads//lib/dry/monads/task.rb#111
  def fmap(&_arg0); end

  # @api public
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/task.rb#141
  def inspect; end

  # @api public
  # @return [Class]
  #
  # source://dry-monads//lib/dry/monads/task.rb#204
  def monad; end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/task.rb#153
  def or(&block); end
  ...
  # @return [Task]
  #
  # source://dry-monads//lib/dry/monads/task.rb#147
  def or_fmap(&_arg0); end

  # source://dry-monads//lib/dry/monads/task.rb#122
  ...
  # @return [Maybe]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#375
  def to_maybe; end
  ...
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/task.rb#125
  def to_s; end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/task.rb#98
  def value!; end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/task.rb#177
  ...
  # @return [Task]
  #
  # source://dry-monads//lib/dry/monads/task.rb#182
  ...
  # @api private
  #
  # source://dry-monads//lib/dry/monads/task.rb#83
  def promise; end
  ...
  # @api private
  #
  # source://dry-monads//lib/dry/monads/task.rb#249
  def compare_promises(x, y); end

  # @api private
  #
  # source://dry-monads//lib/dry/monads/task.rb#235
  def curry(value); end
...
# @api public
#
# source://dry-monads//lib/dry/monads/task.rb#258
module Dry::Monads::Task::Mixin
  ...
  class << self
    ...
    # @return [Module]
    #
    # source://dry-monads//lib/dry/monads/task.rb#269
    def [](executor); end
  end
end
...
# @api public
#
# source://dry-monads//lib/dry/monads/task.rb#284
module Dry::Monads::Task::Mixin::Constructors
  ...
  # @return Task
  #
  # source://dry-monads//lib/dry/monads/task.rb#289
  def Task(&_arg0); end
end
...
# @private
#
# source://dry-monads//lib/dry/monads/task.rb#260
Dry::Monads::Task::Mixin::Task = Dry::Monads::Task

# @api public
# @see Dry::Monads::Unit
#
# source://dry-monads//lib/dry/monads/task.rb#263
...
class Dry::Monads::Task::Promise < ::Concurrent::Promise
  # source://dry-monads//lib/dry/monads/task.rb#15
...
class Dry::Monads::Try
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/try.rb#80
  def error?; end
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/try.rb#81
  def failure?; end
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/try.rb#77
  def success?; end
  ...
  #
  # source://dry-monads//lib/dry/monads/try.rb#86
  def to_monad; end
  ...
  class << self
    ...
    # source://dry-monads//lib/dry/monads/try.rb#33
    def lift(*args, &block); end
...
class Dry::Monads::Try::Error < ::Dry::Monads::Try
  ...
  #
  # source://dry-monads//lib/dry/monads/try.rb#178
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/try.rb#198
  def or(*args); end
  ...
  # @return [Try::Value]
  #
  # source://dry-monads//lib/dry/monads/try.rb#216
  def recover(*errors); end

  # @return [Maybe::None]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#392
  def to_maybe; end

  # @api private
  # @return [Result::Failure]
  #
  # source://dry-monads//lib/dry/monads/result.rb#414
  def to_result; end

  # @api public
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/try.rb#185
  def to_s; end

  class << self
    # source://dry-monads//lib/dry/monads/try.rb#175
    def call(*_arg0); end
  end
end
...
#
# source://dry-monads//lib/dry/monads/try.rb#246
module Dry::Monads::Try::Mixin
  ...
  # @raise [ArgumentError]
  #
  # source://dry-monads//lib/dry/monads/try.rb#294
  ...
  # @raise [ArgumentError]
  #
  # source://dry-monads//lib/dry/monads/try.rb#277
...
# @private
#
# source://dry-monads//lib/dry/monads/try.rb#251
module Dry::Monads::Try::Mixin::Constructors
  ...
  # @return [Try]
  #
  # source://dry-monads//lib/dry/monads/try.rb#259
...
# @see Dry::Monads::Try
#
# source://dry-monads//lib/dry/monads/try.rb#248
...
# @api public
#
# source://dry-monads//lib/dry/monads/try.rb#91
class Dry::Monads::Try::Value < ::Dry::Monads::Try
  ...
  #
  # source://dry-monads//lib/dry/monads/try.rb#100
  ...
  #
  # source://dry-monads//lib/dry/monads/try.rb#126
  def bind(*_arg0, **_arg1, &_arg2); end

  # @api public
  # @return [Array<Exception>] List of exceptions to rescue
  #
  # source://dry-monads//lib/dry/monads/try.rb#96
  def catchable; end
  ...
  # @return [Try::Value, Try::Error]
  #
  # source://dry-monads//lib/dry/monads/try.rb#144
  def fmap(*_arg0, **_arg1, &_arg2); end

  # @api public
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/try.rb#158
  def inspect; end
  ...
  # @return [Try::Value]
  #
  # source://dry-monads//lib/dry/monads/try.rb#165
  def recover(*_errors, &_arg1); end

  # @return [Maybe]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#387
  def to_maybe; end

  # @api private
  # @return [Result::Success]
  #
  # source://dry-monads//lib/dry/monads/result.rb#409
  def to_result; end

  # @api public
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/try.rb#151
  def to_s; end
  ...
  # @api public
  #
  # source://dry-monads//lib/dry/monads/try.rb#107
  def bind_call(*args, **kwargs); end

  class << self
    # source://dry-monads//lib/dry/monads/try.rb#93
    def call(*_arg0); end
...
# @see Validated::Valid
#
# source://dry-monads//lib/dry/monads/validated.rb#271
...
class Dry::Monads::Validated
  ...
  # @raise [NotImplementedError]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#46
  def bind(*_arg0, **_arg1, &_arg2); end
...
# @api private
#
# source://dry-monads//lib/dry/monads/validated.rb#132
class Dry::Monads::Validated::Invalid < ::Dry::Monads::Validated
  ...
  #
  # source://dry-monads//lib/dry/monads/validated.rb#146
  ...
  # @overload alt_map
  #
  # source://dry-monads//lib/dry/monads/validated.rb#180
  def alt_map(proc = T.unsafe(nil), &block); end
  ...
  # @overload apply
  #
  # source://dry-monads//lib/dry/monads/validated.rb#163
  def apply(val = T.unsafe(nil), &block); end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#136
  def error; end
  ...
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#205
  def inspect; end
  ...
  # @overload or
  #
  # source://dry-monads//lib/dry/monads/validated.rb#200
  ...
  # @return [Maybe::None]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#408
  def to_maybe; end
  ...
  # @return [Result::Failure]
  #
  # source://dry-monads//lib/dry/monads/result.rb#432
  def to_result; end

  # @api private
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#206
  def to_s; end
  ...
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#142
  def trace; end
end
...
# @api private
#
# source://dry-monads//lib/dry/monads/validated.rb#217
...
# @api private
#
# source://dry-monads//lib/dry/monads/validated.rb#228
module Dry::Monads::Validated::Mixin::Constructors
  ...
  # @raise [ArgumentError]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#256
  ...
  # @raise [ArgumentError]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#239
...
#
# source://dry-monads//lib/dry/monads/validated.rb#224
...
#
# source://dry-monads//lib/dry/monads/validated.rb#220
...
# @api private
#
# source://dry-monads//lib/dry/monads/validated.rb#54
class Dry::Monads::Validated::Valid < ::Dry::Monads::Validated
  ...
  #
  # source://dry-monads//lib/dry/monads/validated.rb#57
  def initialize(value); end
  ...
  # @return [Boolean]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#125
  def ===(other); end
  ...
  # @return [Validated::Valid]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#106
  def alt_map(_ = T.unsafe(nil), &_arg1); end
  ...
  # @overload apply
  #
  # source://dry-monads//lib/dry/monads/validated.rb#84
  def apply(val = T.unsafe(nil), &_arg1); end
  ...
  # @overload fmap
  #
  # source://dry-monads//lib/dry/monads/validated.rb#98
  def fmap(proc = T.unsafe(nil), &block); end

  # @api private
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#114
  def inspect; end
  ...
  # @return [Validated::Valid]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#111
  ...
  # @return [Maybe::Some]
  #
  # source://dry-monads//lib/dry/monads/maybe.rb#401
  def to_maybe; end
  ...
  # @return [Result::Success]
  #
  # source://dry-monads//lib/dry/monads/result.rb#425
  def to_result; end

  # @api private
  # @return [String]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#121
  def to_s; end
  ...
  # @return [Object]
  #
  # source://dry-monads//lib/dry/monads/validated.rb#66
  def value!; end
end
