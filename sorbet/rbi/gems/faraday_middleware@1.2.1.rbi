...
# pkg:gem/faraday_middleware#lib/faraday_middleware/backwards_compatibility.rb:3
module Faraday; end

# Autoload classes for Faraday::Request.
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/backwards_compatibility.rb:5
class Faraday::Request < ::Struct; end

# deprecated alias
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:90
Faraday::Request::OAuth = FaradayMiddleware::OAuth

# deprecated alias
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth2.rb:88
...
# Autoload classes for Faraday::Request.
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/backwards_compatibility.rb:11
class Faraday::Response; end

# deprecated alias
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/mashify.rb:39
Faraday::Response::Mashify = FaradayMiddleware::Mashify

# deprecated alias
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_json.rb:50
Faraday::Response::ParseJson = FaradayMiddleware::ParseJson

# deprecated alias
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_marshal.rb:15
Faraday::Response::ParseMarshal = FaradayMiddleware::ParseMarshal

# deprecated alias
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_xml.rb:17
Faraday::Response::ParseXml = FaradayMiddleware::ParseXml

# deprecated alias
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_yaml.rb:39
Faraday::Response::ParseYaml = FaradayMiddleware::ParseYaml

# deprecated alias
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/rashify.rb:17
Faraday::Response::Rashify = FaradayMiddleware::Rashify

# Main FaradayMiddleware module.
#
# pkg:gem/faraday_middleware#lib/faraday_middleware.rb:6
module FaradayMiddleware; end

# Public: Caches GET responses and pulls subsequent ones from the cache.
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:9
class FaradayMiddleware::Caching < ::Faraday::Middleware
  ...
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:42
  def initialize(app, cache = T.unsafe(nil), options = T.unsafe(nil)); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:23
  def build_query(*args, **_arg1, &block); end

  # Returns the value of attribute cache.
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:10
  def cache; end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:71
  def cache_key(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:98
  def cache_on_complete(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:52
  def call(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:91
  def custom_status_codes; end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:122
  def finalize_response(response, env); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:87
  def full_key?; end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:83
  def params_to_ignore; end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:23
  def parse_query(*args, **_arg1, &block); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:112
...
# * 410 - 'Gone'
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/caching.rb:20
...
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/chunked.rb:7
class FaradayMiddleware::Chunked < ::FaradayMiddleware::ResponseMiddleware
  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/chunked.rb:28
  def chunked_encoding?(headers); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/chunked.rb:24
  def parse_response?(env); end
end

# pkg:gem/faraday_middleware#lib/faraday_middleware/response/chunked.rb:8
...
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/request/encode_json.rb:13
class FaradayMiddleware::EncodeJson < ::Faraday::Middleware
  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/encode_json.rb:22
  def call(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/encode_json.rb:29
  def encode(data); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/encode_json.rb:45
  def has_body?(env); end

  # @yield []
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/encode_json.rb:33
  def match_content_type(env); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/encode_json.rb:40
  def process_request?(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/encode_json.rb:49
  def request_type(env); end
end

# pkg:gem/faraday_middleware#lib/faraday_middleware/request/encode_json.rb:14
FaradayMiddleware::EncodeJson::CONTENT_TYPE = T.let(T.unsafe(nil), String)

# pkg:gem/faraday_middleware#lib/faraday_middleware/request/encode_json.rb:15
FaradayMiddleware::EncodeJson::MIME_TYPE = T.let(T.unsafe(nil), String)

# pkg:gem/faraday_middleware#lib/faraday_middleware/request/encode_json.rb:16
...
#   end
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:25
class FaradayMiddleware::FollowRedirects < ::Faraday::Middleware
  ...
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:58
  def initialize(app, options = T.unsafe(nil)); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:66
  def call(env); end

  private

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:125
  def callback; end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:140
  def clear_authorization_header(env, from_url, to_url); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:72
  def convert_to_get?(response); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:117
  def follow_limit; end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:112
  def follow_redirect?(env, response); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:77
  def perform_with_redirection(env, follows); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:147
  ...
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:133
  def safe_escape(uri); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:121
  def standards_compliant?; end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:93
  def update_env(env, request_body, response); end
end

# HTTP methods for which 30x redirects can be followed
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:27
FaradayMiddleware::FollowRedirects::ALLOWED_METHODS = T.let(T.unsafe(nil), Set)

# pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:40
FaradayMiddleware::FollowRedirects::AUTH_HEADER = T.let(T.unsafe(nil), String)

# Keys in env hash which will get cleared between requests
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:31
FaradayMiddleware::FollowRedirects::ENV_TO_CLEAR = T.let(T.unsafe(nil), Set)

# Default value for max redirects followed
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:34
FaradayMiddleware::FollowRedirects::FOLLOW_LIMIT = T.let(T.unsafe(nil), Integer)

# HTTP redirect status codes that this middleware implements
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:29
FaradayMiddleware::FollowRedirects::REDIRECT_CODES = T.let(T.unsafe(nil), Set)

# Regex that matches characters that need to be escaped in URLs, sans
# the "%" character which we assume already represents an escaped sequence.
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/follow_redirects.rb:38
...
# - em_http
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:15
class FaradayMiddleware::Gzip < ::Faraday::Middleware
  # pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:82
  def brotli_inflate(body); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:38
  def call(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:68
  def inflate(body); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:86
  def raw_body(body); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:56
  def reset_body(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:62
  def uncompress_gzip(body); end

  class << self
    # pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:18
    def optional_dependency(lib = T.unsafe(nil)); end

    # pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:27
    def supported_encodings; end
  end
end

# pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:33
FaradayMiddleware::Gzip::ACCEPT_ENCODING = T.let(T.unsafe(nil), String)

# pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:25
FaradayMiddleware::Gzip::BROTLI_SUPPORTED = T.let(T.unsafe(nil), FalseClass)

# pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:34
FaradayMiddleware::Gzip::CONTENT_ENCODING = T.let(T.unsafe(nil), String)

# pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:35
FaradayMiddleware::Gzip::CONTENT_LENGTH = T.let(T.unsafe(nil), String)

# pkg:gem/faraday_middleware#lib/faraday_middleware/gzip.rb:36
...
#   end
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/instrumentation.rb:22
class FaradayMiddleware::Instrumentation < ::Faraday::Middleware
  # @return [Instrumentation] a new instance of Instrumentation
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/instrumentation.rb:25
  def initialize(app, options = T.unsafe(nil)); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/instrumentation.rb:30
  def call(env); end
end
...
# Hash or Array type.
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/mashify.rb:8
class FaradayMiddleware::Mashify < ::Faraday::Response::Middleware
  # @return [Mashify] a new instance of Mashify
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/mashify.rb:20
  def initialize(app = T.unsafe(nil), options = T.unsafe(nil)); end

  # Returns the value of attribute mash_class.
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/mashify.rb:9
  def mash_class; end
  ...
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/mashify.rb:25
  def parse(body); end

  class << self
    # Returns the value of attribute mash_class.
    #
    # pkg:gem/faraday_middleware#lib/faraday_middleware/response/mashify.rb:12
    def mash_class; end
...
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/request/method_override.rb:15
class FaradayMiddleware::MethodOverride < ::Faraday::Middleware
  ...
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/method_override.rb:24
  def initialize(app, options = T.unsafe(nil)); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/method_override.rb:32
  def call(env); end

  # Internal: Write the original HTTP method to header, change method to POST.
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/method_override.rb:47
  def rewrite_request(env, original_method); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/method_override.rb:38
  def rewrite_request?(method); end
end

# pkg:gem/faraday_middleware#lib/faraday_middleware/request/method_override.rb:16
...
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:25
class FaradayMiddleware::OAuth < ::Faraday::Middleware
  extend ::Forwardable

  # @return [OAuth] a new instance of OAuth
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:35
  def initialize(app, options); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:64
  def body_params(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:40
  def call(env); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:74
  def include_body_params?(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:45
  def oauth_header(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:56
  def oauth_options(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:33
  def parse_nested_query(*args, **_arg1, &block); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:52
  def sign_request?(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:79
...
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth2.rb:29
class FaradayMiddleware::OAuth2 < ::Faraday::Middleware
  ...
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth2.rb:56
  def initialize(app, token = T.unsafe(nil), options = T.unsafe(nil)); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth2.rb:37
  def build_query(*args, **_arg1, &block); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth2.rb:39
  def call(env); end

  # Returns the value of attribute param_name.
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth2.rb:34
  def param_name; end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth2.rb:37
  def parse_query(*args, **_arg1, &block); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth2.rb:77
...
# pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth2.rb:32
FaradayMiddleware::OAuth2::AUTH_HEADER = T.let(T.unsafe(nil), String)

# pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth2.rb:30
FaradayMiddleware::OAuth2::PARAM_NAME = T.let(T.unsafe(nil), String)

# pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth2.rb:31
FaradayMiddleware::OAuth2::TOKEN_TYPE = T.let(T.unsafe(nil), String)

# pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:28
FaradayMiddleware::OAuth::AUTH_HEADER = T.let(T.unsafe(nil), String)

# pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:29
FaradayMiddleware::OAuth::CONTENT_TYPE = T.let(T.unsafe(nil), String)

# pkg:gem/faraday_middleware#lib/faraday_middleware/request/oauth.rb:30
FaradayMiddleware::OAuth::TYPE_URLENCODED = T.let(T.unsafe(nil), String)

# DRAGONS
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:88
module FaradayMiddleware::OptionsExtension
  # @yield [:preserve_raw, preserve_raw]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:95
  def each; end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:102
  def fetch(key, *args); end

  # Returns the value of attribute preserve_raw.
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:89
  ...
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:91
  def to_hash; end
end

# Parse dates from response body
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_dates.rb:8
class FaradayMiddleware::ParseDates < ::Faraday::Response::Middleware
  # @return [ParseDates] a new instance of ParseDates
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_dates.rb:12
  def initialize(app, options = T.unsafe(nil)); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_dates.rb:17
  def call(env); end

  private

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_dates.rb:25
  def parse_dates!(value); end
end

# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_dates.rb:9
FaradayMiddleware::ParseDates::ISO_DATE_FORMAT = T.let(T.unsafe(nil), Regexp)

# Public: Parse response bodies as JSON.
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_json.rb:7
...
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_json.rb:22
class FaradayMiddleware::ParseJson::MimeTypeFix < ::FaradayMiddleware::ResponseMiddleware
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_json.rb:39
  def first_char(body); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_json.rb:35
  def parse_response?(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_json.rb:25
  def process_response(env); end
end

# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_json.rb:32
FaradayMiddleware::ParseJson::MimeTypeFix::BRACKETS = T.let(T.unsafe(nil), Array)

# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_json.rb:23
FaradayMiddleware::ParseJson::MimeTypeFix::MIME_TYPE = T.let(T.unsafe(nil), String)

# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_json.rb:33
...
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_marshal.rb:7
class FaradayMiddleware::ParseMarshal < ::FaradayMiddleware::ResponseMiddleware; end

# Public: parses response bodies with MultiXml.
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_xml.rb:7
...
#     end
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/parse_yaml.rb:29
...
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/rack_compatible.rb:9
class FaradayMiddleware::RackCompatible
  # @return [RackCompatible] a new instance of RackCompatible
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/rack_compatible.rb:10
  def initialize(app, rack_handler, *args); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/rack_compatible.rb:21
  def call(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/rack_compatible.rb:80
  def finalize_response(env, rack_response); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/rack_compatible.rb:50
  def headers_to_rack(env); end

  # faraday to rack-compatible
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/rack_compatible.rb:30
  def prepare_env(faraday_env); end

  # rack to faraday-compatible
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/rack_compatible.rb:61
  def restore_env(rack_env); end
end

# pkg:gem/faraday_middleware#lib/faraday_middleware/rack_compatible.rb:27
...
# Hash or Array type.
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response/rashify.rb:8
class FaradayMiddleware::Rashify < ::FaradayMiddleware::Mashify; end

# Exception thrown when the maximum amount of requests is
# exceeded.
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/redirect_limit_reached.rb:8
class FaradayMiddleware::RedirectLimitReached < ::Faraday::ClientError
  ...
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/redirect_limit_reached.rb:11
  def initialize(response); end

  # Returns the value of attribute response.
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/redirect_limit_reached.rb:9
  def response; end
end

# Internal: The base class for middleware that parses responses.
#
# pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:8
class FaradayMiddleware::ResponseMiddleware < ::Faraday::Middleware
  ...
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:28
  def initialize(app = T.unsafe(nil), options = T.unsafe(nil)); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:35
  ...
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:51
  def parse(body); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:78
  def parse_response?(env); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:82
  def preserve_raw?(env); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:41
  def process_response(env); end

  # @return [Boolean]
  #
  # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:72
  def process_response_type?(type); end

  # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:66
  def response_type(env); end

  class << self
    # Store a Proc that receives the body and returns the parsed result.
    #
    # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:16
    def define_parser(parser = T.unsafe(nil), &block); end

    # @private
    #
    # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:22
    def inherited(subclass); end

    # Returns the value of attribute parser.
    #
    # pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:12
    def parser; end
...
# pkg:gem/faraday_middleware#lib/faraday_middleware/response_middleware.rb:9
