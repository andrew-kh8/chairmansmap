...
module FFI::CPL; end
module FFI::CPL::String; end
module FFI::CPL::VSI; end
...
#
# pkg:gem/ffi#lib/ffi/tools/const_generator.rb:20
class FFI::ConstGenerator
  ...
  # @return
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:39
  ...
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:67
  def [](name); end
  ...
  # @return [nil]
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:107
  ...
  # @overload const
  # @overload const
  # @param cast [String] a C cast for the value
  # @param format [String] a printf format string to print the value out
  # @param name [#to_s] C constant name
  # @param ruby_name alternate ruby name for {#to_ruby}
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:86
  ...
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:22
  def constants; end
  ...
  # @return [nil]
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:157
  ...
  # @param i [List<String>, Array<String>] include file(s)
  # @return [Array<String>] array of include files
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:181
  def include(*i); end
  ...
  # @return [String]
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:167
  def to_ruby; end
  ...
  class << self
    ...
    #
    # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:61
    def options; end
    ...
    # @return [Hash] class options
    #
    # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:56
...
#
# pkg:gem/ffi#lib/ffi/tools/const_generator.rb:188
class FFI::ConstGenerator::Constant
  # @param cast [String] a C cast for the value
  # @param converter [#call] convert the value from a string to the appropriate
  #   type for {#to_ruby}.
  # @param format [String] a printf format string to print the value out
  # @param name [#to_s]
  # @param ruby_name alternate ruby name for {#to_ruby}
  ...
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:199
  def initialize(name, format, cast, ruby_name = T.unsafe(nil), converter = T.unsafe(nil)); end

  # Returns the value of attribute cast.
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:190
  def cast; end
  ...
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:210
  ...
  # @return [String]
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:220
  def ruby_name; end
  ...
  # @return [String]
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:226
  def to_ruby; end

  # Returns the value of attribute value.
  #
  # pkg:gem/ffi#lib/ffi/tools/const_generator.rb:191
  def value; end
