...
module FFaker::Bank
  ...
  # source://ffaker//lib/ffaker/bank.rb#114
  def loan_amount(min_amount = T.unsafe(nil), max_amount = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/bank.rb#106
  def loan_interest_rate(min_rate = T.unsafe(nil), max_rate = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/bank.rb#110
  def loan_term; end
  ...
  # @raise [ArgumentError]
  #
  # source://ffaker//lib/ffaker/bank.rb#124
  def check_country_existence(country_code); end

  # source://ffaker//lib/ffaker/bank.rb#120
...
module FFaker::BankUS
  ...
  # source://ffaker//lib/ffaker/bank_us.rb#10
  def account_number(min_digits: T.unsafe(nil), max_digits: T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/bank_us.rb#14
  def routing_number; end

  private

  # source://ffaker//lib/ffaker/bank_us.rb#25
  def generate_ninth_digit(num_string); end
end

# source://ffaker//lib/ffaker/bank_us.rb#8
FFaker::BankUS::ROUTING_NUMBER_PREFIXES = T.let(T.unsafe(nil), Array)
...
module FFaker::Boolean
  ...
  # source://ffaker//lib/ffaker/boolean.rb#19
  def random; end

  # source://ffaker//lib/ffaker/boolean.rb#20
  def sample; end
end
...
module FFaker::Guid
  ...
  #
  # source://ffaker//lib/ffaker/guid.rb#13
  def guid; end
end
...
# source://ffaker//lib/ffaker/identification_fi.rb#4
module FFaker::IdentificationFI
  extend ::FFaker::RandomUtils
  extend ::FFaker::ModuleUtils
  extend ::FFaker::IdentificationFI

  # source://ffaker//lib/ffaker/identification_fi.rb#16
  def identity_number(gender: T.unsafe(nil), birthday: T.unsafe(nil), fake: T.unsafe(nil)); end

  private

  # source://ffaker//lib/ffaker/identification_fi.rb#61
  def calculate_check_digit(birthday, individual_number); end

  # @raise [ArgumentError]
  #
  # source://ffaker//lib/ffaker/identification_fi.rb#67
  def check_birth_year(birth_year); end

  # source://ffaker//lib/ffaker/identification_fi.rb#28
  def fetch_formatted_day(birthday); end

  # source://ffaker//lib/ffaker/identification_fi.rb#32
  def fetch_formatted_month(birthday); end

  # source://ffaker//lib/ffaker/identification_fi.rb#36
  def fetch_formatted_year(birthday); end

  # source://ffaker//lib/ffaker/identification_fi.rb#52
  def fetch_individual_number(gender, fake); end

  # source://ffaker//lib/ffaker/identification_fi.rb#41
  def fetch_separator(birthday); end
end

# source://ffaker//lib/ffaker/identification_fi.rb#8
FFaker::IdentificationFI::CHECK_DIGITS = T.let(T.unsafe(nil), String)

# Number ranges not in real use
#
# source://ffaker//lib/ffaker/identification_fi.rb#13
FFaker::IdentificationFI::FAKE_FEMALE_INDIVIDUAL_NUMBERS = T.let(T.unsafe(nil), Array)

# source://ffaker//lib/ffaker/identification_fi.rb#14
FFaker::IdentificationFI::FAKE_MALE_INDIVIDUAL_NUMBERS = T.let(T.unsafe(nil), Array)

# Number ranges in real use
#
# source://ffaker//lib/ffaker/identification_fi.rb#10
FFaker::IdentificationFI::POSSIBLY_REAL_FEMALE_INDIVIDUAL_NUMBERS = T.let(T.unsafe(nil), Array)

# source://ffaker//lib/ffaker/identification_fi.rb#11
FFaker::IdentificationFI::POSSIBLY_REAL_MALE_INDIVIDUAL_NUMBERS = T.let(T.unsafe(nil), Array)
...
# source://ffaker//lib/ffaker/job_tw.rb#4
module FFaker::JobTW
  extend ::FFaker::RandomUtils
  extend ::FFaker::ModuleUtils
  extend ::FFaker::JobTW

  # source://ffaker//lib/ffaker/job_tw.rb#8
  def title; end
end
...
# source://ffaker//lib/ffaker/lorem_tw.rb#4
module FFaker::LoremTW
  extend ::FFaker::RandomUtils
  extend ::FFaker::ModuleUtils
  extend ::FFaker::LoremTW

  # source://ffaker//lib/ffaker/lorem_tw.rb#32
  def paragraph(sentence_count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem_tw.rb#36
  def paragraphs(paragraph_count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem_tw.rb#16
  def sentence(word_count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem_tw.rb#22
  def sentences(sentence_count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem_tw.rb#8
  def word; end

  # source://ffaker//lib/ffaker/lorem_tw.rb#12
  def words(num = T.unsafe(nil)); end
end
...
#
# source://ffaker//lib/ffaker/uuid.rb#14
module FFaker::UUID
  extend ::FFaker::RandomUtils
  extend ::FFaker::ModuleUtils
  extend ::FFaker::UUID
  ...
  #
  # source://ffaker//lib/ffaker/uuid.rb#20
  def uuidv4; end
  ...
  #
  # source://ffaker//lib/ffaker/uuid.rb#51
  def uuidv6; end
  ...
  #
  # source://ffaker//lib/ffaker/uuid.rb#100
  def uuidv7; end
  ...
  #
  # source://ffaker//lib/ffaker/uuid.rb#140
  def uuidv8; end

  private

  # source://ffaker//lib/ffaker/uuid.rb#169
  def as_string(uuid); end
end
