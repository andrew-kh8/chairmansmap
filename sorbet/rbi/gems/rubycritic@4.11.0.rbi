...
# source://rubycritic//lib/rubycritic/configuration.rb#75
module RubyCritic::Config
  class << self
    # @return [Boolean]
    #
    # source://rubycritic//lib/rubycritic/configuration.rb#88
    def build_mode?; end

    # @return [Boolean]
    #
    # source://rubycritic//lib/rubycritic/configuration.rb#84
    def compare_branches_mode?; end

    # source://rubycritic//lib/rubycritic/configuration.rb#76
    def configuration; end

    # source://rubycritic//lib/rubycritic/configuration.rb#92
    def method_missing(method, *_arg1, **_arg2, &_arg3); end

    # @return [Boolean]
    #
    # source://rubycritic//lib/rubycritic/configuration.rb#100
...
class RubyCritic::Configuration
  ...
  # Sets the attribute coverage_path
  #
  # @param value the value to set the attribute coverage_path to.
  #
  # source://rubycritic//lib/rubycritic/configuration.rb#8
  ...
  # source://rubycritic//lib/rubycritic/configuration.rb#51
  def root=(path); end
  ...
  # source://rubycritic//lib/rubycritic/configuration.rb#62
...
class RubyCritic::SourceControlSystem::Git < ::RubyCritic::SourceControlSystem::Base
  ...
  # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#60
  def date_of_last_commit(path); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#20
  def git(arg); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#68
  def head_reference; end

  # @return [Boolean]
  #
  # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#64
  def revision?; end

  # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#56
  ...
  # @return [Boolean]
  #
  # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#111
  def stash_changes?; end

  # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#118
  def stashes_count; end

  # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#122
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#38
    ...
    # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#92
    ...
    # @return [Boolean]
    #
    # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#26
    def supported?; end

    # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#79
    def switch_branch(branch); end

    # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#48
    def to_s; end

    # source://rubycritic//lib/rubycritic/source_control_systems/git.rb#86
...
#
# source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#25
class RubyCritic::SourceControlSystem::Git::Churn
  # :reek:TooManyStatements
  #
  # @return [Churn] a new instance of Churn
  #
  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#27
  def initialize(churn_after: T.unsafe(nil), paths: T.unsafe(nil)); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#41
  def date_of_last_commit(path); end
  ...
  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#96
  def after_clause; end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#60
  def call; end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#64
  def exec_git_command(command); end

  # :reek:DuplicateMethodCall
  #
  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#124
  def filename_for_subdirectory(filename); end

  # :reek:DuplicateMethodCall
  #
  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#48
  def find_git_root; end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#79
  def git_log_command(path); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#75
  def git_log_commands; end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#137
  ...
  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#114
  def process_date(date); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#141
  def process_file(filename); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#100
  def process_line(line); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#118
  def process_rename(from, to); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#145
  def record_commit(filename, date); end

  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#150
  def renames; end

  # :reek:TooManyStatements
  #
  # source://rubycritic//lib/rubycritic/source_control_systems/git/churn.rb#156
  def stats(path); end
end
...
class RubyCritic::SourceControlSystem::Mercurial < ::RubyCritic::SourceControlSystem::Base
  # source://rubycritic//lib/rubycritic/source_control_systems/mercurial.rb#21
  def date_of_last_commit(path); end

  # @return [Boolean]
  #
  # source://rubycritic//lib/rubycritic/source_control_systems/mercurial.rb#25
  def revision?; end

  # source://rubycritic//lib/rubycritic/source_control_systems/mercurial.rb#17
  def revisions_count(path); end
  ...
  class << self
    ...
    # source://rubycritic//lib/rubycritic/source_control_systems/mercurial.rb#13
    def to_s; end
  end
end
...
class RubyCritic::SourceControlSystem::Perforce < ::RubyCritic::SourceControlSystem::Base
  ...
  # source://rubycritic//lib/rubycritic/source_control_systems/perforce.rb#61
  def head_reference; end

  # @return [Boolean]
  #
  # source://rubycritic//lib/rubycritic/source_control_systems/perforce.rb#56
  def revision?; end
  ...
  # source://rubycritic//lib/rubycritic/source_control_systems/perforce.rb#113
  def perforce_files; end

  class << self
    # source://rubycritic//lib/rubycritic/source_control_systems/perforce.rb#65
    ...
    # source://rubycritic//lib/rubycritic/source_control_systems/perforce.rb#92
    def compute_cache_lines(lines); end

    # source://rubycritic//lib/rubycritic/source_control_systems/perforce.rb#78
    ...
    # source://rubycritic//lib/rubycritic/source_control_systems/perforce.rb#86
    def insert_file_cache(file_cache, lines); end

    # source://rubycritic//lib/rubycritic/source_control_systems/perforce.rb#103
    def key_file(source_file_path); end

    # source://rubycritic//lib/rubycritic/source_control_systems/perforce.rb#107
