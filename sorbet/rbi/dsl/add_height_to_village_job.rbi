...
# This is an autogenerated file for dynamic methods in `AddHeightToVillageJob`.
# Please instead update this file by running `bin/tapioca dsl AddHeightToVillageJob`.


class AddHeightToVillageJob
  class << self
